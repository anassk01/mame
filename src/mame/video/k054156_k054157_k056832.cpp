...
k054156_056832_device::k054156_056832_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, uint32_t clock)
...
static int off_for_x[][7] = {
	{ 6000000, 2, 48, 288, 16, 32, 22 }, // gokuparo
	{ 6000000, 1, 46, 288, 18, 32, 17 }, // mystwarr
	{ 6000000, 1, 48, 288, 16, 32, 26 }, // mmaulers
	{ 6000000, 0, 39, 288, 17, 40, 17 }, // metamrph
	{ 8000000, 0, 55, 384, 33, 40, 13 }, // xexex
	{ }
};
...
{
	//	static const uint16_t xdelta[4] = { 0, 2, 4, 5 };
	static const uint16_t xdelta[4] = { 0, 4, 6, 8 };
